...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	else
	{
		...
		if($stm!=false)
		{
			...
			echo '<script>alert("Realizador adcionado com sucesso");</script>';
...
else
{
	...
	<body style="background: #BFFAF7">
		<h1 style="color: darkblue">Adicionar realizadores</h1>
		<form action="create_realizadores.php" method="post">
